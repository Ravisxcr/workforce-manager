...
import type { UserLogin, UserSignUp, ChangePassword, ForgotPassword, ResetPassword, UserInfo } from '@/types'
...
export const addUser = (data: UserSignUp) => post<void>('/auth/add-user', data)
